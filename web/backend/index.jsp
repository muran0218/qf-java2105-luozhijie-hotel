...
<title>餐馆王后台管理</title>
	...
	<frameset rows="100px,*,19px" framespacing="0" border="0" frameborder="0">
		<frame src="backend/detail/top.html" scrolling="no" noresize />
		<frameset cols="178px,*">
			<frame noresize src="backend/detail/left.jsp" scrolling="yes" />
			<frame noresize name="right" src="backend/detail/right.html" scrolling="yes" />
		</frameset>
		<frame noresize name="status_bar" scrolling="no" src="backend/detail/bottom.html" />
	</frameset>
	<noframes>
		<body>
